...
<div class="panel panel-info">
    <div class="panel-heading">
        <div class="panel-title">
            <a href="#" data-toggle="collapse" data-bs-toggle="collapse" data-target="#moreinfo" data-bs-target="#moreinfo"><i class="fa fa-info-circle"></i></a>
...
<div id="toolbar-all">
    <a href='?display=calendar' class="btn btn-default"><i
            class='fa fa-calendar'></i>&nbsp;<?php echo _("View Calendars")?></a>
    <a href='?display=calendargroups&amp;action=add' class="btn btn-default"><i
            class='fa fa-plus'></i>&nbsp;<?php echo _("Add Group")?></a>
</div>
<table 	id="mygrid" data-url="<?php echo $dataurl?>" 
		data-cache="false" 
		data-cookie="true"
...
function linkFormatter(value, row, index) {
    ...
    html += '&nbsp;<a href="?display=calendargroups&action=delete&id=' + value +
