...
class UtilityMethods extends PHPUnit_Framework_TestCase{
	...
	public function testObjToCronCarbon(){
		...
		$this->assertEquals("26 20 5 9 3 /foo/bar.baz", self::$o->objToCron($foo,'/foo/bar.baz'), "objToCron returned an unexpected string for Carbon object");
	}
	public function testObjToCronMoment(){
		$timestamp = '@1346901971';
		$foo = new \Moment\Moment($timestamp,'America/Phoenix');
		$this->assertEquals("26 20 5 9 3 /foo/bar.baz", self::$o->objToCron($foo,'/foo/bar.baz'), "objToCron returned an unexpected string for Moment object");
	}
	...
	public function testObjToCronStringUnixtime(){
		$this->assertEquals("26 20 5 9 3 /foo/bar.baz", self::$o->objToCron('1346901971','/foo/bar.baz'), "objToCron returned an unexpected string for Moment object");
	}
	public function testObjToCronStringDate(){
		$this->assertEquals("26 20 5 9 3 /foo/bar.baz", self::$o->objToCron('05 Sep 2012 20:26:11','/foo/bar.baz'), "objToCron returned an unexpected string for Moment object");
	}
}
